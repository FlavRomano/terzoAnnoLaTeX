...
Consiste nel creare tante istanze delle formule quantificate universalemnte quanti sono gli oggetti menzionati, per poi eliminare i quantificatori esistenziali skolemizzando.
...
- Le applicazioni di funzioni sono infite, quindi posso creare infinite istanze $$Giovanni,Padre(Giovanni),Padre(Padre(Giovanni)),\ldots$$

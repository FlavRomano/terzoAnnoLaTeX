...
/**
 * @desc Class that sends notifications to the multicast group that all clients join.
 * The notifications are used to let users know that someone has just posted a game session.

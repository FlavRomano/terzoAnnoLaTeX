...
/**
 * @desc Class that manages and maintains consistent user information as a response to
...
public class ServerUserAccess {
     ...
     * @code1 "ko" If user already logged in another client.
     * @code2 "NOTREG" If user not yet registered.
     * @code3 "WRGPSW" If the password sent does not match the password in the Database.
     */
    ...
    /**
     * @param username
     * @return Retrieves the User object, using the username, from the Json Database.
     */
